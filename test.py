...
from utils import psnr,ssim,get_hr_lr_bicubic,preprocess_to_tesnor,preprocess_to_pil,preprocess_to_y,merge
...
if __name__ == '__main__':
    ...
    print('output and hr psnr:{}'.format(psnr(hr1,preds)))
    print('bicubic and hr ssim:{}'.format(ssim(bicubic1,hr1)))
    print('output and hr ssim:{}'.format(ssim(preds,hr1)))
    if args.mode=='y':
